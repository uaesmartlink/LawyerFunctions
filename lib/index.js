...
exports.confirmConsultation = functions.firestore
    ...
    if (newValue.status == "success" &&
        ...
        await db
            .collection("Lawyers")
            .doc((_a = timeSlot.data()) === null || _a === void 0 ? void 0 : _a.lawyerId)
            .get()
            .then((querySnapshot) => {
            var _a;
            let lawyerBalance = (_a = querySnapshot.data()) === null || _a === void 0 ? void 0 : _a.balance;
        ...
        let userId = await db
            .collection("Users")
            .where("lawyerId", "==", (_b = timeSlot.data()) === null || _b === void 0 ? void 0 : _b.lawyerId)
            .get()
